...
@property(assign) id delegate;   // should implement the MGScopeBarDataSource protocol.
@property(assign) id dataSource; // should implement the MGScopeBarDelegate protocol.
